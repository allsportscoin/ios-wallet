...
enum RPCServer {
    ...
    var chainID: Int {
        ...
        case .callisto: return 3
        case .gochain: return 3
        case .soc: return 3
        }
    }
    ...
    var priceID: Address {
        ...
        case .soc: return EthereumAddress(string: "0x2d0E95bd4795D7aCe0da3C0Ff7b706a5970eb9D3")!
        }
    }
    ...
    var isDisabledByDefault: Bool {
        ...
        case .soc, .poa, .classic, .callisto, .gochain: return true
        }
    }
    ...
    var name: String {
        ...
        case .callisto: return "Callisto"
        case .gochain: return "GoChain"
        case .soc: return "All Sports Coin"
        }
    }
    ...
    var rpcURL: URL {
        let urlString: String = {
            ...
            case .soc: return "http://test-socscan.allsportschain.com/v1/jsonrpc/mainnet"
            }
        }()
    ...
    var addressHexString: String {
        ...
        case .classic, .poa, .callisto, .gochain:
            return ""
        case .soc: return "0x2d0E95bd4795D7aCe0da3C0Ff7b706a5970eb9D3"
        }
    }
    ...
    var openseaPath: String {
        switch self {
        case .main, .soc, .classic, .poa, .callisto, .gochain: return Constants.dappsOpenSea
        }
    }
