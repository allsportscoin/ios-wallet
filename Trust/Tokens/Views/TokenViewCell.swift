...
//        walletName.alignment = .firstBaseline
//        walletName.distribution = .equalSpacing
//        walletName.spacing = TokensLayout.cell.arrangedSubviewsOffset
//
        let leftStackView = UIStackView(arrangedSubviews: [walletName,titleLabel])
    ...
    func configure(viewModel: TokenViewCellViewModel) {
        ...
        titleLabel.textColor = viewModel.marketPriceTextColor
        titleLabel.font = viewModel.marketPriceFont
        ...
        walletName.text = viewModel.store.account.info.name
        walletName.textColor = viewModel.titleTextColor
        walletName.font = viewModel.titleFont
        
        walletName.translatesAutoresizingMaskIntoConstraints = false
        walletName.lineBreakMode = .byTruncatingMiddle
        walletName.adjustsFontSizeToFitWidth = true
        walletName.minimumScaleFactor = 0.7
